...
- [문체 — 리포트 전체에 반드시 적용] 목표는 "정확한데 세련되고 다정하게 읽히는 글"이다. 사실은 정확하게, 해석은 사람처럼 쓴다.
  ...
  · [좋은 예 — 이런 톤을 목표로 한다] "AI 반도체의 핵심인 HBM 기대감, 하루가 다르게 높아지는 실적 눈높이, 그리고 9월 들어 다시 돌아온 매수세까지 삼박자가 딱 맞물린 시점입니다. 최근 주가가 단기에 빠르게 올라 잠시 흔들릴 수는 있습니다. 하지만 '주가가 비싸진 게 아닐까?'라는 걱정보다, 기업이 실제로 벌어들일 돈(이익)이 늘어나는 속도가 훨씬 빠릅니다. 따라서 지금처럼 치솟는 주식을 조급하게 따라 사기보다는, 주가가 잠시 숨고르기하며 살짝 낮아질 때(눌림목)를 차분히 기다리는 것이 훨씬 정교하고 안전한 전략입니다."
  · [나쁜 예 — 이렇게 쓰지 않는다] "HBM 기대와 실적 상향, 그리고 9월 들어 확인된 수급 반전이 동시에 붙은 구간이다. 단기 급등 뒤 변동성은 남아 있지만, 밸류에이션 부담보다 이익 추정 상향 속도가 더 빠르다. 오늘은 추격보다 눌림을 보는 쪽이 더 정교하다." (문제: '-다'체라 딱딱하고, 용어를 안 풀고 그대로 썼고, 독자에게 말을 거는 느낌이 없다)
