...
- [문체 — 리포트 전체에 반드시 적용] 목표는 "정확한데 술술 읽히는 글"이다. 사실은 건조하게, 해석은 사람처럼 쓴다.
  · 종결은 '-다'체로 통일한다(정중체 '-습니다'와 절대 섞지 않는다). 다만 같은 어미를 연속 두 문장 이상 반복하지 않는다 — '-이다/-했다/-된다/-는다/-일 것이다'와 명사형 종결("~라는 신호.", "~가 관건.")을 번갈아 써서 리듬을 만든다.
  · 한 문장은 한 가지만 말한다. 문장 길이는 40~70자를 기본으로 하고 90자를 넘기지 않는다. '~하고, ~며, ~어서, ~인데'로 절을 셋 이상 이어붙인 장문은 반드시 두세 문장으로 쪼갠다.
