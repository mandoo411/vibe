...
const INDICATOR_KO = {
  ...
  // 2026-07-31: TradingView 경제캘린더 소스 전환에 맞춰 추가(다른 표기 방식)
  "Durable Goods Orders Ex Transp MoM": "내구재 주문 (운송 제외, 월간)",
  "Dallas Fed Manufacturing Index": "댈러스 연준 제조업지수",
  "Retail Inventories Ex Autos MoM Adv": "소매재고 (자동차 제외, 속보치)",
  "Wholesale Inventories MoM Adv": "도매재고 (속보치)",
  "S&P/Case-Shiller Home Price YoY": "S&P/케이스-실러 주택가격지수 (연간)",
  "API Crude Oil Stock Change": "API 원유재고 변화",
  "MBA 30-Year Mortgage Rate": "MBA 30년 모기지 금리",
  "EIA Crude Oil Stocks Change": "EIA 원유재고 변화",
  "EIA Gasoline Stocks Change": "EIA 휘발유재고 변화",
  "PCE Price Index YoY": "PCE 물가지수 (연간)",
  "GDP Price Index QoQ Adv": "GDP 물가지수 (분기, 속보치)",
  "Employment Cost - Wages QoQ": "고용비용지수 - 임금 (분기)",
  "Employment Cost - Benefits QoQ": "고용비용지수 - 복리후생 (분기)",
  "Employment Cost Index QoQ": "고용비용지수 (분기)",
  "Unit Labour Costs QoQ Prel": "단위노동비용 (분기, 속보치)",
  "Nonfarm Productivity QoQ Prel": "비농업 생산성 (분기, 속보치)",
  "Participation Rate": "경제활동참가율",
  "CPI s.a": "소비자물가지수 (계절조정)",
  "Monthly Budget Statement": "월간 재정수지",
  "Retail Sales Control Group MoM": "소매판매 컨트롤그룹 (월간)",
  "Business Inventories MoM": "기업재고 (월간)",
  "Fed Press Conference": "연준 기자회견",
  "Fed Interest Rate Decision Upper Bound": "연준 금리 결정 (상단)",
  "Fed Interest Rate Decision Lower Bound": "연준 금리 결정 (하단)",
};
