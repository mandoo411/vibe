...
// 2026-09-25: 브라우저(daily-market.html 등)에서도 같은 달력을 쓰도록 즉시실행 함수로 감싼다(전역 오염 방지).
(function () {
const HOLIDAYS = {
  // 2026 (확정)
  "2026-01-01": "신정",
...
function calendarWarning(ymd = seoulYmd()) {
  ...
  if (y === CONFIRMED_UNTIL_YEAR && m === 12) {
    return `한국거래소가 12월 중 ${y + 1}년 휴장일을 공지합니다 — lib/krx-calendar.js의 ${y + 1}년(잠정치)과 대조해 확정해 주세요.`;
  }
...
if (typeof window !== "undefined") window.KRX_CAL = API;
})();
