...
- disparity: {period:20|60|120|200, op:"lt"|"lte"|"gt"|"gte", value:숫자(%)} — 이격도
...
- trading_value: {op:"lt"|"lte"|"gt"|"gte", value:숫자(억원)} — 당일 누적 거래대금. "거래대금 50억
  이상"이면 value:50, op:"gte" (단위는 항상 억원으로 환산)
...
function buildSnapshotFromSeries(series) {
  const { closes, highs, lows, volumes, ma, rsiSeries, divergence, candles, macd, bollinger, stochastic, adx, marketCapEok, tradingValueEok } = series;
