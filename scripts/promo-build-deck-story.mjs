...
2·3번 이슈 카드: 오늘 시장을 움직인 서로 다른 원인 2개. 각각
   ...
   chain 좋은 예) "미국·이란 대표단이 뉴욕에서 접촉, 이란이 <b>호르무즈 재개방</b> 제안" / "코스피 <b>7,153.99</b>, 1.94% 뛰며 출발"
   chain 나쁜 예) "코스피 상승 출발" / "미국 반도체주 강세" (너무 짧고 구체성이 없다)
...
5. 훅(hookHTML)은 한 문장, <br>로 3줄, 한 줄은 공백 포함 11자 이내(카드 폭). 숫자는 많아야 1개.
...
# 출력 (JSON만)
{
  ...
  "issues": [
    {"kicker": "카드 머리 라벨 12자 이내 (예: 아침 급등의 이유)",
     ...
     "chain": [{"label": "사건|반응|겹친 호재|부담|버팀목|배경 중 하나", "text": "25~40자. 누가·무엇을·얼마나가 들어간 구체적 문장, 핵심어 <b>"}, {"label": "결과", "text": "마지막은 반드시 label=결과. 지수·종목이 실제로 어떻게 됐는지 원문 숫자로"}],
     "stocks": ["이 이슈로 움직인 종목명 1~2개 (반드시 1개 이상)"]},
