...
import { slideStoryHook, slideIssue, slideMovers, slideNext, withTheme } from "./promo-carousel-story.mjs";
...
export function buildersFor(deck) {
  ...
  if (deck.layout === "closing-story" || deck.layout === "morning-story") {
