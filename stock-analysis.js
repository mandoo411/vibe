(function () {
  ...
  function renderSupplyFlowFact(supplyFlow) {
    ...
    return (
      ...
      // 2026-09-18: 장종료 전에는 1일 수치가 마감까지 계속 바뀌는 잠정치라, 고정 문구를
      // AI 프로즈에만 맡기지 않고 코드가 직접 표 위에 얹는다(매번 표현이 달라지는 걸 방지).
      (supplyFlow.isToday
        ? `<p class="ai-supply-fact__note">※ 1일 수급은 오늘 장중 잠정치입니다. 장 마감 후 최종 확정됩니다.</p>`
        : "") +
